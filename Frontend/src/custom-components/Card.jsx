...
const Card = ({ imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  return (
    <Link
      to={`/auction/item/${id}`}
      className="flex-grow basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80 max-w-[300px] max-h-[400px] overflow-hidden"
    >
      <img
        src={imgSrc}
        alt={title}
        className="w-full aspect-[4/3] m-auto md:p-12 object-cover"
      />
      <div className="px-2 pt-4 pb-2 overflow-hidden">
