        ...
        {loading ? (
          ...
          <>
            <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
              <img
                src={user.profileImage?.public_url}
                alt=""
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        defaultValue={
                          user.paymentMethod.upiPayments.upiId
                        }
                        className="w-ful mt-1 p-2 border-gray-300 rounded-md focus:outline-none"
                        disabled
                      />
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        defaultValue={user.paymentMethod.payPal.paypalEmail}
                        className="w-ful mt-1 p-2 border-gray-300 rounded-md focus:outline-none"
                        disabled
                      />
                    </div>
                  ...
                  {user.role === "Auctioneer" && (
                    <>
                      <div>
                        ...
                        <input
                          type="text"
                          defaultValue={user.unpaidCommissions}
                          className="w-ful mt-1 p-2 border-gray-300 rounded-md focus:outline-none"
                          disabled
                        />
                      </div>
